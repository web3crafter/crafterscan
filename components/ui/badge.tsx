...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-gray-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 dark:border-gray-800 dark:focus:ring-gray-800",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary-dark-900 text-gray-50 hover:bg-primary-dark-900/80",
        secondary:
        ...
        success:
          "border-transparent bg-green-500 text-gray-50 hover:bg-green-500/80 dark:bg-green-900 dark:text-green-50 dark:hover:bg-green-900/80",
      },
    },
    defaultVariants: {
      variant: "default",
